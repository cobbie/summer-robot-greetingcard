/**
 * This java class contains the drawing of the Trapezoid object. The shape makes use of a Path2d.Double object
 * to create the shape along with the passed in values of its parameters.
 *
...
public class Trapezoid implements DrawingObject {
    ...
    /**
     * The constructor of this Trapezoid class takes in the x coordinate, the y coordinate, the width and height, and the
