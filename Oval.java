/**
 * This java class contains the drawing of the Oval object. It simply makes use of the Ellipse2D.Double object
 * and uses the passed width and height parameters to create the specific shape.
 *
...
public class Oval implements DrawingObject {
    ...
    /**
     * The constructor of this Oval class takes in the x coordinate, the y coordinate, the width and height, and the
    ...
    /**
     * The draw method for this class instantiates and draws an oval object.
